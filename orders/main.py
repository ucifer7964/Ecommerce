...
def order_add(background_task: BackgroundTasks,
              request: Request,
    ...
    db_order = crud.create_order(db, first_name, last_name, email, address, postal_code, city, coupon_id=cart.coupon_id, discount=cart.get_discount())
    ...
    send_mail = mail.Mail()
    background_task.add_task(send_mail.send_notification())
